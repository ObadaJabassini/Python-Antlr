package java.executor;// Generated from C:\Users\Obada\Desktop\python-ast\src\main\antlr\Python3.g4 by ANTLR 4.2.2
...
public interface Python3Listener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterProg(@NotNull Python3Parser.ProgContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#prog}.
	 * @param ctx the parse tree
	 */
	void exitProg(@NotNull Python3Parser.ProgContext ctx);
